...
static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_proto_2fhello_2eproto[2];
static constexpr ::PROTOBUF_NAMESPACE_ID::EnumDescriptor const** file_level_enum_descriptors_proto_2fhello_2eproto = nullptr;
static constexpr ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor const** file_level_service_descriptors_proto_2fhello_2eproto = nullptr;

const uint32_t TableStruct_proto_2fhello_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_proto_2fhello_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\021proto/hello.proto\022\005hello\"\034\n\014HelloReque"
  "st\022\014\n\004name\030\001 \001(\t\"\035\n\nHelloReply\022\017\n\007messag"
  "e\030\001 \001(\t2A\n\tHelloGrpc\0224\n\010SayHello\022\023.hello"
  ".HelloRequest\032\021.hello.HelloReply\"\000B \n\006nx"
  "u.itB\016HelloGrpcProtoP\001Z\004.;pbb\006proto3"
  ;
static ::PROTOBUF_NAMESPACE_ID::internal::once_flag descriptor_table_proto_2fhello_2eproto_once;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_proto_2fhello_2eproto = {
  false, false, 196, descriptor_table_protodef_proto_2fhello_2eproto, "proto/hello.proto", 
  &descriptor_table_proto_2fhello_2eproto_once, nullptr, 0, 2,
  schemas, file_default_instances, TableStruct_proto_2fhello_2eproto::offsets,
  file_level_metadata_proto_2fhello_2eproto, file_level_enum_descriptors_proto_2fhello_2eproto, file_level_service_descriptors_proto_2fhello_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_proto_2fhello_2eproto_getter() {
  return &descriptor_table_proto_2fhello_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_proto_2fhello_2eproto(&descriptor_table_proto_2fhello_2eproto);
namespace hello {
